...
class User_manage(AbstractUser):
...
class Medical(models.Model):
    ...
    patient = models.ForeignKey(User_manage, related_name="patient", on_delete= models.CASCADE)
    doctor = models.ForeignKey(User_manage, related_name="doctor", on_delete= models.CASCADE, null=True)
...
class Ment(models.Model):
    ...
    patient = models.ForeignKey(User_manage, related_name="pat", on_delete= models.CASCADE)
    doctor = models.ForeignKey(User_manage, related_name="dor", on_delete= models.CASCADE, null=True)
...
class Profile(models.Model):
    user = models.OneToOneField(User_manage, on_delete=models.CASCADE)
